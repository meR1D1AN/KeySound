...
- Ведёт **счётчик прожатых клавиш** и показывает его в заголовке иконки в трее.
...
Готовый exe будет в `dist/keysound.exe` (его размер будет 21,6 МБ (22 745 714 байт))
